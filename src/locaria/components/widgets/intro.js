		...
		return (
			...
			>
				<Box className={classes.navIntroBox}>
					{configs.intro}
					<FormGroup>
						<FormControlLabel control={<Checkbox color="secondary" id={"dismiss"} onChange={handleChange}/>} label="Don't show again" />
						<Button size="small" color="secondary" variant="outlined" onClick={closeIntro}>Get Started</Button>
					</FormGroup>
				</Box>
			</Modal>
		)
