...
$$
    ...
    BEGIN
        ...
        RAISE NOTICE '%', locaria_tests.test_result_processor('get_parameters TEST 1', ret_var , '{parameters,test_1,test_1}', '10');
        ...
        RAISE NOTICE '%', locaria_tests.test_result_processor('get_parameters TEST 3', ret_var , '{parameters,test_1,test_1}', '10');
        ...
        RAISE NOTICE '%', locaria_tests.test_result_processor('get_parameters TEST 5', ret_var , '{parameters,test_1,test_1}', '10');
